		...
		<div class="container">
			<div class="breadcrumbs">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Thanh Toán Gio Hàng</li>
                </ol>
            </div>
			...
			<div class="shopper-informations">
					...
					<div class="col-sm-12 clearfix">
						<div class="bill-to">
                            ...
                            <input type="button" value="Xác nhận đơn hàng" name="send_order" class="btn btn-primary btn-sm send_order">
                                ...
                                <input type="button" name="calculate_order"value="Tính Phí Vận Chuyển"class="btn btn-primary btn-sm calculate_delivery">
                                </form>
                ...
                <table class="table table-condensed">
                   ...
                   @foreach(Session::get('cart') as $key => $cart)
                      ...
                      <tr>
                          <td>
                              <input type="submit" name="update_qty"value="Cập nhật giỏ hàng"class="check_out btn btn-default btn-sm">
                          </td>
                          <td>
                      ...
                      <tr>
                        <td>
                            <?php 
                                echo'Thêm Sản Phẩm Vào Gio hàng để Thanh toán';
                           ?> 
                        </td>
                   ...
                   <form method="post" action="{{url('/check-coupon')}}">
                        @csrf
                          <input type="text" class="form-control" name="coupon" placeholder="Nhap ma giam gia">
                            <input type="submit" class="btn btn-default check_out"  name="check_coupon" value="Tinh ma giam gia">
                             @if(Session::get('coupon'))
