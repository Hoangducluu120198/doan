...
class CheckoutController extends Controller
{
    ...
    public function save_checkou_customer(Request $request){
        $data = array();
   ...
   /* public function payment(){
    ...
    public function order_place(Request $request)
    {
        ...
        $order_data['customer_id']= Session::get('customer_id');
         ...
         foreach($contenst as $v_conten){
          $order_d_data = array();
        $order_d_data['order_id']= $order_id;
         $order_d_data['product_id']= $v_conten->id;
         $order_d_data['product_name']= $v_conten->name;
         $order_d_data['product_price']= $v_conten->price;
         $order_d_data['product_sales_quantity']= $v_conten->qty;
    ...
    public function login_customer(Request $request){
        $email = $request->emal_account;
        $password = md5($request->password_account);
        $result = DB::table('tbl_customer')->where('customer_email',$email)->where('customer_password',$password)->
        first();
    ...
    public function manage_order(){
       ...
       $manger_order = view('admin.manage_order')->with('all_order',$all_order);
        return view('HomeAdmin')->with('admin.manage_order',$manger_order);
    }
    public function view_order($orderId){
       ...
       $manger_order_by_id = view('admin.view_order')->with('order_by_id',$order_by_id);
        return view('HomeAdmin')->with('admin.view_order',$manger_order_by_id);
